...
<jsp:useBean id="ctx"
	type="com.dianping.egret.console.page.monitor.Context" scope="request" />
<jsp:useBean id="payload"
	type="com.dianping.egret.console.page.monitor.Payload" scope="request" />
<jsp:useBean id="model"
	type="com.dianping.egret.console.page.monitor.Model" scope="request" />
